...
class TheMachine {
    ...
    postDBLoad(container) {
        ...
        this.logger.logWithColor(`${pkg.name} [LOADED]: Time To Kill Some Hecklers!`, LogTextColor_1.LogTextColor.BLUE, LogBackgroundColor_1.LogBackgroundColor.YELLOW);
    }
    ...
    addTraderToLocales(tables) {
        ...
        locales.forEach(locale => {
            ...
            locale[`${baseJson._id} Description`] = "A distinguished man, who needs no introduction.";
        });
    }
